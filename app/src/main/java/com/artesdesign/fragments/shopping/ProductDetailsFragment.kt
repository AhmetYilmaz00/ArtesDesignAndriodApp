...
import com.artesdesign.adapters.ColorsAdapter
import com.artesdesign.adapters.SizesAdapter
import com.artesdesign.adapters.ViewPager2ImagesAdapter
import com.artesdesign.augmentedReality.R
import com.artesdesign.augmentedReality.databinding.FragmentProductDetailsBinding
import com.artesdesign.data.CartProduct
import com.artesdesign.util.Resource
import com.artesdesign.util.dpToPx
import com.artesdesign.util.hideBottomNavigationView
import com.artesdesign.viewmodel.shopping.DetailsViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            product.offerPercentage?.let {
                ...
                tvProductPrice.text = "${String.format("%.2f",priceAfterOffer)} TL"
            }
            ...
            arIcon.setOnClickListener {
                if(product.model == null){
                    Toast.makeText(requireContext(), "Ne yazık ki, henüz mevcut bir model yok.", Toast.LENGTH_SHORT).show()
                }else{
