package com.artesdesign.viewmodel.settings
        ...
        viewModelScope.launch {
            ...
            try{
                val imgBitMap = MediaStore.Images.Media
                    .getBitmap(getApplication<AugmentedReality>().contentResolver,imageUri)
