...
import com.artesdesign.augmentedReality.databinding.BestDealsRvItemBinding
        ...
        fun bind(product:Product){
            ...
            binding.apply {
                ...
                product.offerPercentage?.let {
                    ...
                    tvPrice.text = "${String.format("%.2f",priceAfterOffer)} TL"
                }
                tvBestDealsOldPrice.text = "${product.price} TL"
